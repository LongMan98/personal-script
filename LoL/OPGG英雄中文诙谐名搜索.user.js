...
(function() {
    ...
    const heroNameMap = {
        // 战士类
        "盖伦": "garen", "大宝剑": "garen", "草丛伦": "garen", "gay伦": "garen", "德玛西亚之力": "garen",
        "诺手": "darius", "达瑞斯": "darius", "人头狗": "darius", "诺克萨斯之手": "darius", "德莱厄斯": "darius",
        "鳄鱼": "renekton", "雷克顿": "renekton", "荒漠屠夫": "renekton",
        "狗头": "nasus", "内瑟斯": "nasus", "沙漠死神": "nasus",
        "剑魔": "aatrox", "暗裔剑魔": "aatrox", "亚托克斯": "aatrox",
        "剑姬": "fiora", "菲奥娜": "fiora", "无双剑姬": "fiora",
        "青钢影": "camille", "卡蜜尔": "camille", "剪刀腿": "camille",
        "腕豪": "sett", "瑟提": "sett", "劲夫": "sett", "万豪": "sett",
        "赵信": "xinzhao", "赵云": "xinzhao", "赵子龙": "xinzhao", "菊花信": "xinzhao", "德邦总管": "xinzhao",
        "皇子": "jarvaniv", "嘉文四世": "jarvaniv", "德玛西亚皇子": "jarvaniv",
        "剑圣": "masteryi", "易大师": "masteryi", "蛮易信": "masteryi", "无极剑圣": "masteryi",
        "蛮王": "tryndamere", "蛮子": "tryndamere", "五秒真男人": "tryndamere", "蛮族之王": "tryndamere", "·泰达米尔": "tryndamere",
        "武器": "jax", "贾克斯": "jax", "武器大师": "jax",
        "盲僧": "leesin", "李青": "leesin", "瞎子": "leesin", "小学僧": "leesin",
        "偷男": "sylas", "塞拉斯": "sylas", "解脱者": "sylas", "蒜男": "sylas",
        "约里克": "yorick", "掘墓者": "yorick", "掘墓": "yorick", "牧魂人": "yorick",
        "卑尔维斯": "belveth", "阿尔卑斯": "belveth", "虚空鱼": "belveth", "虚空女皇": "belveth",
        "克烈": "kled", "暴怒骑士": "kled",
        ...
        "船长": "gangplank", "桶子哥": "gangplank", "普朗克": "gangplank", "橘子哥": "gangplank", "海洋之灾": "gangplank",
        "纳尔": "gnar", "小纳尔": "gnar", "大纳尔": "gnar", "迷失之牙": "gnar",
        "潘森": "pantheon", "斯巴达": "pantheon", "长枪哥": "pantheon", "不屈之枪": "pantheon",
        "蔚": "vi", "拳姐": "vi", "皮城大姐头": "vi", "皮城执法官": "vi",
        "猴子": "wukong", "悟空": "wukong", "齐天大圣": "wukong", "猴哥": "wukong", "孙悟空": "wukong",
        "百裂冥犬": "naafiri", "纳亚菲利": "naafiri",
        "铁血狼母": "ambessa", "狼母": "ambessa", "狼妈": "ambessa", "铁血母狼": "ambessa", "安蓓萨": "ambessa",
        "狂厄蔷薇": "briar", "蔷薇": "briar", "小蔷薇": "briar", "抽血泵": "briar", "疯批蔷薇": "briar", "荆棘妹": "briar", "贝蕾亚": "briar",
        ...
        "阿克尚": "akshan", "阿克曼": "akshan", "影哨": "akshan",
        "破败之王": "viego", "佛耶戈": "viego", "佛爷": "viego", "破败王": "viego", "破财王": "viego",
        "凯隐": "kayn", "拉亚斯特": "kayn", "红凯": "kayn", "蓝凯": "kayn", "凯": "kayn", "影流之镰": "kayn", "镰刀": "kayn", "凯影": "kayn",
        "奇亚娜": "qiyana", "元素女皇": "qiyana", "盘子妈": "qiyana",
        "小丑": "shaco", "萨科": "shaco", "恶魔小丑": "shaco",
        "黛安娜": "diana", "皎月女神": "diana", "皎月": "diana", "露娜": "diana",
        ...
        "石头人": "malphite", "墨菲特": "malphite", "混分巨兽": "malphite", "岩头人": "malphite", "熔岩巨兽": "malphite",
        "牛头": "alistar", "阿里斯塔": "alistar", "阿利斯塔": "alistar","牛头人": "alistar","ntr": "alistar", "牛头酋长": "alistar", "阿利斯塔": "alistar",
        "机器人": "blitzcrank", "布里茨": "blitzcrank", "蒸汽机器人": "blitzcrank",
        ...
        "蝎子": "skarner", "斯卡纳": "skarner", "水晶先锋": "skarner", "上古领主": "skarner",
        "狗熊": "volibear", "沃利贝尔": "volibear", "不灭狂雷": "volibear",
        "木乃伊": "amumu", "阿木木": "amumu", "殇之木乃伊": "amumu", "木木": "amumu",
        "慎": "shen", "暮光之眼": "shen", "肾": "shen", "腰子": "shen",
        "塔姆": "tahmkench", "塔姆肯奇": "tahmkench", "河流之王": "tahmkench", "蛤蟆": "tahmkench", "鲶鱼": "tahmkench", "塔姆·肯奇": "tahmkench",
        ...
        "光辉": "lux", "光女": "lux", "拉克丝": "lux", "光辉女郎": "lux",
        ...
        "薇古丝": "vex", "小恶魔": "vex", "摆烂熊": "vex", "熬夜波比": "vex", "愁云使者": "vex",
        ...
        "VN": "vayne", "薇恩": "vayne", "暗夜猎手": "vayne", "红眼睛": "vayne", "红眼镜": "vayne",
        ...
        "不破之誓": "yunara", "云娜": "yunara", "芸阿娜": "yunara",
        ...
        "璐璐": "lulu", "仙灵女巫": "lulu",
        "娜美": "nami", "唤潮鲛姬": "nami", "人鱼": "nami", "美人鱼": "nami",
        "巴德": "bard", "星界游神": "bard",
        ...
        "洛": "rakan", "幻翎": "rakan",
        "炼金男爵": "renata", "炼金妈": "renata", "男爵妈": "renata", "烈娜塔": "renata", "烈娜塔·戈拉斯克": "renata",

        // 快乐风男系列
        "托儿索": "yasuo", "快乐风男": "yasuo", "亚索": "yasuo", "压缩": "yasuo", "风男": "yasuo", "剑豪": "yasuo", "疾风剑豪": "yasuo"
    };
